...
func @main()->(){
    ...
    %t45 = memref.get_global @b : memref<1xindex> loc("main.isq":56:21)
    %t46 = arith.constant 0 : index loc("main.isq":56:21)
    %t47 = memref.subview %t45[%t46][1][1] : memref<1xindex> to memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":56:21)
    %x33 = affine.load %t47[0] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":56:21)
    %x34 = arith.constant 1 : index loc("main.isq":56:23)
    %x35 = arith.addi %x33, %x34 : index loc("main.isq":56:20)
    affine.for %t48 = %x32 to %x35 step 1 {
        %t49 = memref.alloca() : memref<1xindex> loc("main.isq":56:9)
        %t50 = arith.constant 0 : index loc("main.isq":56:9)
        %x36 = memref.subview %t49[%t50][1][1] : memref<1xindex> to memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":56:9)
        affine.store %t48, %x36[0]: memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":56:9)
    ...
    %x37 = memref.subview %t51[%t52][5][1] : memref<5xindex> to memref<5xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":59:13)
    ...
    %x38 = affine.load %t55[0] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":60:15)
    %x39 = memref.subview %x37[%x38][1][1] : memref<5xindex, affine_map<(d0)[s0]->(d0+s0)>> to memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":60:13)
    %x40 = affine.load %x39[0] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":60:13)
    %x41 = arith.constant 2 : index loc("main.isq":60:18)
    %x42 = arith.addi %x40, %x41 : index loc("main.isq":60:13)
    ...
    affine.store %x42, %t58[0]: memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":60:9)
    %x43 = affine.load %x14[0] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":61:20)
    ...
    %x44 = call @test(%t61, %t64, %x43) : (memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>>, memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>>, index)->index loc("main.isq":61:9)
    ...
    affine.store %x44, %t67[0]: memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":61:5)
    %x45 = arith.constant 0 : index loc("main.isq":62:17)
    ...
    %x46 = memref.subview %t70[%x45][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":62:15)
    %t71 = affine.load %x46[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":62:13)
    %t72, %t73 = isq.call_qop @isq_builtin::@measure(%t71): [1]()->i1 loc("main.isq":62:13)
    affine.store %t72, %x46[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":62:13)
    %x47 = arith.index_cast %t73 : i1 to index loc("main.isq":62:13)
    ...
    affine.store %x47, %t76[0]: memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":62:9)
    %x48 = arith.constant 0 : index loc("main.isq":63:19)
    ...
    %x49 = memref.subview %t79[%x48][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":63:17)
    ...
    %t86 = affine.load %x49[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":63:9)
    ...
    affine.store %t88, %x49[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":63:9)
    %x50 = arith.constant 0 : index loc("main.isq":65:25)
    ...
    %x51 = memref.subview %t94[%x50][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":65:23)
    %x52 = arith.constant 1 : index loc("main.isq":65:31)
    ...
    %x53 = memref.subview %t97[%x52][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":65:29)
    ...
    %t100 = affine.load %x51[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":65:9)
    %t101 = affine.load %x53[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":65:9)
    ...
    affine.store %t106, %x51[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":65:9)
    affine.store %t107, %x53[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":65:9)
    ...
    %x54 = arith.constant 1 : index loc("main.isq":66:21)
    ...
    %x55 = memref.subview %t114[%x54][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":66:19)
    %x56 = arith.constant 0 : index loc("main.isq":66:27)
    ...
    %x57 = memref.subview %t117[%x56][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":66:25)
    ...
    %t120 = affine.load %x55[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":66:9)
    %t121 = affine.load %x57[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":66:9)
    ...
    affine.store %t126, %x55[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":66:9)
    affine.store %t127, %x57[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":66:9)
    ...
    %x58 = arith.constant 0 : index loc("main.isq":67:23)
    ...
    %x59 = memref.subview %t134[%x58][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":67:21)
    ...
    %t137 = affine.load %x59[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":67:9)
    ...
    affine.store %t142, %x59[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":67:9)
    ...
    %x60 = arith.constant 0 : index loc("main.isq":68:31)
    ...
    %x61 = memref.subview %t149[%x60][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":68:29)
    %x62 = arith.constant 1 : index loc("main.isq":68:37)
    ...
    %x63 = memref.subview %t152[%x62][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":68:35)
    %x64 = arith.constant 2 : index loc("main.isq":68:43)
    ...
    %x65 = memref.subview %t155[%x64][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":68:41)
    ...
    %t158 = affine.load %x61[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":68:9)
    %t159 = affine.load %x63[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":68:9)
    %t160 = affine.load %x65[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":68:9)
    ...
    affine.store %t165, %x61[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":68:9)
    affine.store %t166, %x63[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":68:9)
    affine.store %t167, %x65[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":68:9)
    ...
    %x66 = arith.constant 0 : index loc("main.isq":69:26)
    ...
    %x67 = memref.subview %t174[%x66][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":69:24)
    %x68 = arith.constant 2 : index loc("main.isq":69:32)
    ...
    %x69 = memref.subview %t177[%x68][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":69:30)
    %x70 = arith.constant 1 : index loc("main.isq":69:41)
    ...
    %x71 = memref.subview %t180[%x70][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":69:39)
    ...
    %t183 = affine.load %x67[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":69:9)
    %t184 = affine.load %x69[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":69:9)
    ...
    %t189 = affine.load %x71[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":69:9)
    %t190,%t191,%t192,%t193 = isq.apply %t182(%t183,%t184,%t188,%t189) : !isq.gate<4> loc("main.isq":69:9)
    affine.store %t190, %x67[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":69:9)
    affine.store %t191, %x69[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":69:9)
    ...
    affine.store %t193, %x71[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":69:9)
    scf.while () : ()->(){
        ...
        %x72 = affine.load %t199[0] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":71:16)
        %x73 = arith.constant 2 : index loc("main.isq":71:20)
        %t200 = arith.cmpi "slt", %x72, %x73 : index loc("main.isq":71:16)
        %x74 = arith.index_cast %t200: i1 to index loc("main.isq":71:16)
        %t207 = arith.index_cast %x74 : index to i1 loc("main.isq":71:9)
        ...
        %x75 = affine.load %t203[0] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":72:21)
        %x76 = arith.constant 1 : index loc("main.isq":72:25)
        %x77 = arith.addi %x75, %x76 : index loc("main.isq":72:21)
        ...
        affine.store %x77, %t206[0]: memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":72:17)
        scf.yield
    } loc("main.isq":71:9)
    ...
    %x78 = affine.load %t210[0] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":75:15)
    isq.call_qop @isq_builtin::@print_int(%x78): [0](index)->() loc("main.isq":75:9)
    ...
    %x79 = arith.constant 1 : index loc("main.isq":77:11)
    ...
    %x80 = memref.subview %t221[%x79][1][1] : memref<3x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> to memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":77:9)
    %t222 = affine.load %x80[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":77:9)
    %t223 = isq.call_qop @isq_builtin::@reset(%t222): [1]()->() loc("main.isq":77:9)
    affine.store %t223, %x80[0] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("main.isq":77:9)
    return
}
