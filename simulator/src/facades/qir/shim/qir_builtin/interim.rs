...
pub extern "C" fn __isq__qir__shim__rt__array_concatenate(x0: *mut i8, x1: *mut i8)->*mut i8 {
    ...
    unsafe { t(isq_qir_shim_rt_array_concatenate(t::<_, K<QIRArray>>(x0), t::<_, K<QIRArray>>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__array_create_1d(x0: i32, x1: i64)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_array_create_1d(t::<_, i32>(x0), t::<_, i64>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__array_get_element_ptr(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_array_get_element_ptr(t::<_, K<QIRArray>>(x0), t::<_, *mut i64>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__array_get_element_ptr_1d(x0: *mut i8, x1: i64)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_array_get_element_ptr_1d(t::<_, K<QIRArray>>(x0), t::<_, i64>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__array_get_size(x0: *mut i8, x1: i32)->i64 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_array_get_size(t::<_, K<QIRArray>>(x0), t::<_, i32>(x1)))}
}
#[no_mangle]
...
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__array_project(x0: *mut i8, x1: i32, x2: i64, x3: bool)->*mut i8 {
    use core::mem::transmute as t;
...
pub extern "C" fn __isq__qir__shim__rt__array_update_alias_count(x0: *mut i8, x1: i32)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_array_update_alias_count(t::<_, K<QIRArray>>(x0), t::<_, i32>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__array_update_reference_count(x0: *mut i8, x1: i32)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_array_update_reference_count(t::<_, K<QIRArray>>(x0), t::<_, i32>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_add(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_add(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_bitand(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_bitand(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_bitor(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_bitor(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_bitxor(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_bitxor(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_create_array(x0: i32, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_create_array(t::<_, i32>(x0), t::<_, *mut i8>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__bigint_divide(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_divide(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_equal(x0: *mut i8, x1: *mut i8)->bool {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_equal(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__bigint_greater(x0: *mut i8, x1: *mut i8)->bool {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_greater(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_greater_eq(x0: *mut i8, x1: *mut i8)->bool {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_greater_eq(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_modulus(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_modulus(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_multiply(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_multiply(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__bigint_power(x0: *mut i8, x1: i32)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_power(t::<_, K<QIRBigInt>>(x0), t::<_, i32>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_shiftleft(x0: *mut i8, x1: i64)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_shiftleft(t::<_, K<QIRBigInt>>(x0), t::<_, i64>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_shiftright(x0: *mut i8, x1: i64)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_shiftright(t::<_, K<QIRBigInt>>(x0), t::<_, i64>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__bigint_subtract(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_subtract(t::<_, K<QIRBigInt>>(x0), t::<_, K<QIRBigInt>>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__bigint_update_reference_count(x0: *mut i8, x1: i32)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_bigint_update_reference_count(t::<_, K<QIRBigInt>>(x0), t::<_, i32>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__callable_make_adjoint(x0: *mut i8)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_callable_make_adjoint(t::<_, K<QIRCallable>>(x0)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__callable_make_controlled(x0: *mut i8)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_callable_make_controlled(t::<_, K<QIRCallable>>(x0)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__callable_update_alias_count(x0: *mut i8, x1: i32)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_callable_update_alias_count(t::<_, K<QIRCallable>>(x0), t::<_, i32>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__callable_update_reference_count(x0: *mut i8, x1: i32)->() {
    use core::mem::transmute as t;
...
pub extern "C" fn __isq__qir__shim__rt__result_equal(x0: *mut i8, x1: *mut i8)->bool {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_result_equal(t::<_, QIRResult>(x0), t::<_, QIRResult>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__result_update_reference_count(x0: *mut i8, x1: i32)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_result_update_reference_count(t::<_, QIRResult>(x0), t::<_, i32>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__string_concatenate(x0: *mut i8, x1: *mut i8)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_string_concatenate(t::<_, K<QIRString>>(x0), t::<_, K<QIRString>>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__string_equal(x0: *mut i8, x1: *mut i8)->bool {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_string_equal(t::<_, K<QIRString>>(x0), t::<_, K<QIRString>>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__string_update_reference_count(x0: *mut i8, x1: i32)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_string_update_reference_count(t::<_, K<QIRString>>(x0), t::<_, i32>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__tuple_copy(x0: *mut i8, x1: bool)->*mut i8 {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_tuple_copy(t::<_, TupleBodyPtr>(x0), t::<_, bool>(x1)))}
}
#[no_mangle]
...
pub extern "C" fn __isq__qir__shim__rt__tuple_update_alias_count(x0: *mut i8, x1: i32)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_tuple_update_alias_count(t::<_, TupleBodyPtr>(x0), t::<_, i32>(x1)))}
}
#[no_mangle]
pub extern "C" fn __isq__qir__shim__rt__tuple_update_reference_count(x0: *mut i8, x1: i32)->() {
    use core::mem::transmute as t;
    unsafe { t(isq_qir_shim_rt_tuple_update_reference_count(t::<_, TupleBodyPtr>(x0), t::<_, i32>(x1)))}
}
