module{
    ...
    func private @"__quantum__qis__z__body"(!isq.qir.qubit) loc("<stdin>":28:1)
    isq.defgate @"Z" {definition = [{type = "qir", value = @"__quantum__qis__z__body"}]}: !isq.gate<1> loc("<stdin>":28:1)
    ...
    func @"$_ISQ_GATEDEF_test"(memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>>, memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>>) 
    {
    ^entry(%ssa_26: memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>>, %ssa_27: memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>>):
        ...
        memref.store %ssa_28, %ssa_29[%ssa_28_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":42:1)
        %ssa_30 = isq.use @"H" : !isq.gate<1> loc("<stdin>":43:9) 
        %ssa_30_in_1_zero = arith.constant 0: index loc("<stdin>":43:9)
        %ssa_30_in_1 = memref.load %ssa_27[%ssa_30_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":43:9)
        ...
        memref.store %ssa_30_out_1, %ssa_27[%ssa_30_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":43:9)
        %ssa_32 = isq.use @"CNOT" : !isq.gate<2> loc("<stdin>":44:9) 
        %ssa_32_in_1_zero = arith.constant 0: index loc("<stdin>":44:9)
        %ssa_32_in_1 = memref.load %ssa_26[%ssa_32_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":44:9)
        %ssa_32_in_2_zero = arith.constant 0: index loc("<stdin>":44:9)
        %ssa_32_in_2 = memref.load %ssa_27[%ssa_32_in_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":44:9)
        ...
        memref.store %ssa_32_out_1, %ssa_26[%ssa_32_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":44:9)
        %ssa_32_out_2_zero = arith.constant 0: index loc("<stdin>":44:9)
        memref.store %ssa_32_out_2, %ssa_27[%ssa_32_out_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":44:9)
        %ssa_35 = isq.use @"H" : !isq.gate<1> loc("<stdin>":45:9) 
        %ssa_35_in_1_zero = arith.constant 0: index loc("<stdin>":45:9)
        %ssa_35_in_1 = memref.load %ssa_27[%ssa_35_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":45:9)
        ...
        memref.store %ssa_35_out_1, %ssa_27[%ssa_35_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":45:9)
        br ^exit_1 
    ^exit_1:
    ...
    ^entry(%ssa_38: memref<?x!isq.qstate>, %ssa_39: f64):
        ...
        memref.store %ssa_40, %ssa_41[%ssa_40_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":48:1)
        ...
        %ssa_42_in_1 = memref.load %ssa_45[%ssa_42_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":49:9)
        ...
        memref.store %ssa_42_out_1, %ssa_45[%ssa_42_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":49:9)
        br ^exit_1 
    ^exit_1:
    ...
    ^entry:
        ...
        memref.store %ssa_47, %ssa_48[%ssa_47_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":52:1)
        ...
        memref.store %ssa_51, %ssa_52[%ssa_51_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":56:9)
        ...
        scf.if %ssa_55 {
            ...
            ^entry:
                ...
                %ssa_63 = memref.load %ssa_57[%ssa_63_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":57:23)
                ...
                %ssa_68 = memref.load %ssa_65[%ssa_68_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":57:33)
                ...
                %ssa_69 = memref.load %ssa_66[%ssa_69_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":57:35)
                ...
                memref.store %ssa_70, %ssa_56[%ssa_70_zero] : memref<1xf64, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":57:20)
                br ^exit 
            ^exit:
            ...
            ^entry:
                ...
                %ssa_77 = memref.load %ssa_74[%ssa_77_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":60:21)
                ...
                memref.store %ssa_76, %ssa_72[%ssa_76_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":60:19)
                br ^exit_1 
            ^exit_1:
        ...
        %ssa_79 = memref.load %ssa_48[%ssa_79_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":56:9)
    ...
    ^block1:
        ...
        memref.store %ssa_80, %ssa_81[%ssa_80_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":62:9)
        ...
        %ssa_84 = memref.load %ssa_83[%ssa_84_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":62:20)
        ...
        %ssa_89 = memref.load %ssa_48[%ssa_89_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":62:9)
    ...
    ^block2:
        ...
        %ssa_94 = memref.load %ssa_93[%ssa_94_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":66:15)
        ...
        %ssa_98 = memref.load %ssa_95[%ssa_98_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":66:14)
        ...
        memref.store %ssa_97, %ssa_91[%ssa_97_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":66:11)
        ...
        %ssa_100_in_1 = memref.load %ssa_101[%ssa_100_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":67:5)
        %ssa_100_in_2_zero = arith.constant 0: index loc("<stdin>":67:5)
        %ssa_100_in_2 = memref.load %ssa_104[%ssa_100_in_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":67:5)
        ...
        memref.store %ssa_100_out_1, %ssa_101[%ssa_100_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":67:5)
        %ssa_100_out_2_zero = arith.constant 0: index loc("<stdin>":67:5)
        memref.store %ssa_100_out_2, %ssa_104[%ssa_100_out_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":67:5)
        ...
        %ssa_110 = memref.load %ssa_108[%ssa_110_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":68:18)
        ...
        %ssa_117_in = memref.load %ssa_116[%ssa_117_in_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":69:9)
        ...
        memref.store %ssa_117_out, %ssa_116[%ssa_117_out_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":69:9)
        ...
        memref.store %ssa_118, %ssa_113[%ssa_118_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":69:7)
        ...
        %ssa_120_in_1 = memref.load %ssa_121[%ssa_120_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":70:9)
        %ssa_120_in_2_zero = arith.constant 0: index loc("<stdin>":70:9)
        %ssa_120_in_2 = memref.load %ssa_124[%ssa_120_in_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":70:9)
        ...
        memref.store %ssa_120_out_1, %ssa_121[%ssa_120_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":70:9)
        %ssa_120_out_2_zero = arith.constant 0: index loc("<stdin>":70:9)
        memref.store %ssa_120_out_2, %ssa_124[%ssa_120_out_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":70:9)
        ...
        %ssa_125_in_1 = memref.load %ssa_128[%ssa_125_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":72:19)
        %ssa_125_in_2_zero = arith.constant 0: index loc("<stdin>":72:19)
        %ssa_125_in_2 = memref.load %ssa_129[%ssa_125_in_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":72:19)
        ...
        memref.store %ssa_125_out_1, %ssa_128[%ssa_125_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":72:19)
        %ssa_125_out_2_zero = arith.constant 0: index loc("<stdin>":72:19)
        memref.store %ssa_125_out_2, %ssa_129[%ssa_125_out_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":72:19)
        ...
        %ssa_130_in_1 = memref.load %ssa_133[%ssa_130_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":73:20)
        %ssa_130_in_2_zero = arith.constant 0: index loc("<stdin>":73:20)
        %ssa_130_in_2 = memref.load %ssa_136[%ssa_130_in_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":73:20)
        %ssa_130_in_3_zero = arith.constant 0: index loc("<stdin>":73:20)
        %ssa_130_in_3 = memref.load %ssa_137[%ssa_130_in_3_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":73:20)
        %ssa_130_in_4_zero = arith.constant 0: index loc("<stdin>":73:20)
        %ssa_130_in_4 = memref.load %ssa_140[%ssa_130_in_4_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":73:20)
        ...
        memref.store %ssa_130_out_1, %ssa_133[%ssa_130_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":73:20)
        %ssa_130_out_2_zero = arith.constant 0: index loc("<stdin>":73:20)
        memref.store %ssa_130_out_2, %ssa_136[%ssa_130_out_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":73:20)
        %ssa_130_out_3_zero = arith.constant 0: index loc("<stdin>":73:20)
        memref.store %ssa_130_out_3, %ssa_137[%ssa_130_out_3_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":73:20)
        %ssa_130_out_4_zero = arith.constant 0: index loc("<stdin>":73:20)
        memref.store %ssa_130_out_4, %ssa_140[%ssa_130_out_4_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":73:20)
        ...
        memref.store %ssa_142, %ssa_141[%ssa_142_zero] : memref<1xf64, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":74:12)
        ...
        %ssa_148 = memref.load %ssa_145[%ssa_148_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":75:12)
        ...
        %ssa_144_in_1 = memref.load %ssa_150[%ssa_144_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":75:9)
        ...
        memref.store %ssa_144_out_1, %ssa_150[%ssa_144_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":75:9)
        ...
        %ssa_160 = memref.load %ssa_152[%ssa_160_zero] : memref<1xf64, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":76:20)
        ...
        %ssa_151_in_1 = memref.load %ssa_153[%ssa_151_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":76:17)
        %ssa_151_in_2_zero = arith.constant 0: index loc("<stdin>":76:17)
        %ssa_151_in_2 = memref.load %ssa_156[%ssa_151_in_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":76:17)
        %ssa_151_in_3_zero = arith.constant 0: index loc("<stdin>":76:17)
        %ssa_151_in_3 = memref.load %ssa_159[%ssa_151_in_3_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":76:17)
        ...
        memref.store %ssa_151_out_1, %ssa_153[%ssa_151_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":76:17)
        %ssa_151_out_2_zero = arith.constant 0: index loc("<stdin>":76:17)
        memref.store %ssa_151_out_2, %ssa_156[%ssa_151_out_2_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":76:17)
        %ssa_151_out_3_zero = arith.constant 0: index loc("<stdin>":76:17)
        memref.store %ssa_151_out_3, %ssa_159[%ssa_151_out_3_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":76:17)
        ...
        %ssa_167 = memref.load %ssa_165[%ssa_167_zero] : memref<1xf64, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":77:22)
        ...
        %ssa_162_in_1 = memref.load %ssa_166[%ssa_162_in_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":77:9)
        ...
        memref.store %ssa_162_out_1, %ssa_166[%ssa_162_out_1_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":77:9)
        ...
        memref.store %ssa_168, %ssa_169[%ssa_168_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":78:9)
        ...
        memref.store %ssa_170, %ssa_171[%ssa_170_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":78:9)
        scf.while : ()->() {
            %cond = scf.execute_region->i1 {
                ^break_check:
                    %ssa_177_zero = arith.constant 0: index loc("<stdin>":78:9)
                    %ssa_177 = memref.load %ssa_169[%ssa_177_zero] : memref<1xi1, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":78:9)
                ...
                ^while_cond:
                    ...
                    %ssa_175 = memref.load %ssa_172[%ssa_175_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":78:16)
            ...
            ^entry:
                ...
                %ssa_182 = memref.load %ssa_179[%ssa_182_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":79:21)
                ...
                memref.store %ssa_181, %ssa_178[%ssa_181_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":79:19)
                br ^exit 
            ^exit:
        ...
        %ssa_184 = memref.load %ssa_183[%ssa_184_zero] : memref<1xindex, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":82:15)
        ...
        %ssa_185_in = memref.load %ssa_185[%ssa_185_in_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":83:9)
        ...
        memref.store %ssa_185_out, %ssa_185[%ssa_185_out_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":83:9)
        ...
        %ssa_188_in = memref.load %ssa_188[%ssa_188_in_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":84:10)
        ...
        memref.store %ssa_188_out, %ssa_188[%ssa_188_out_zero] : memref<1x!isq.qstate, affine_map<(d0)[s0]->(d0+s0)>> loc("<stdin>":84:10)
        br ^exit_8 
    ^exit_8:
