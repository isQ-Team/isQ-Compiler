...
struct DecomposeMultiRzRule : public mlir::RewritePattern{
    ...
    matchAndRewrite(mlir::Operation * op,
        ...
        if(operands.size()==2){
            // replace with rz.
            emitBuiltinGate(rewriter, "Rz", {&operands[0]}, {angle}, {}, false);
        }else{
            ...
            auto decomposed_gates = synthesis::mcdecompose_addone(total_size);
            ...
            do{
                ...
                for (int i = operands.size()-2; i > 0; i--){
                    ...
                    emitBuiltinGate(rewriter, "Rz", {&operands[i]}, {neg_z_angle});
                }
            }while(0);
...
struct DecomposeCtrlU3Rule : public mlir::OpRewritePattern<ApplyGateOp>{
    ...
    void addMultiRx(mlir::ArrayAttr ctrl, mlir::MutableArrayRef<mlir::Value> qubits, mlir::PatternRewriter& rewriter) const{
    ...
    void addMultiRz(mlir::Value lambda_plus_phi, mlir::MutableArrayRef<mlir::Value> qubits, mlir::PatternRewriter& rewriter) const{
        auto ctx = rewriter.getContext();
        mlir::SmallVector<mlir::Type> qubitTypes;
        qubitTypes.append(qubits.size(), QStateType::get(ctx));
        mlir::SmallVector<mlir::Value> operands;
