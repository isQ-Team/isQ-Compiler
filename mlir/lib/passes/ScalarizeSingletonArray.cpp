...
/*
struct ScalarizeSingletonArray : public mlir::OpRewritePattern<mlir::AffineLoadOp> {
    ScalarizeSingletonArray(mlir::MLIRContext *context)
        : OpRewritePattern<mlir::AffineLoadOp>(context, 1) {
